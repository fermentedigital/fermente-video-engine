...
def build_config(existing: dict | None = None) -> dict:
    ...
    # Preserve any already configured private credentials/settings, then apply
    # the FERMENTE operational defaults below.
    ...
    # Secrets come from the environment. They are written only to the ignored
    # local config.toml, never to tracked source files.
