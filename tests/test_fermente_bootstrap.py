...
def test_fermente_preset_defaults(monkeypatch):
    for name in (
        "FERMENTE_OPENAI_API_KEY", "OPENAI_API_KEY",
        "FERMENTE_PEXELS_API_KEY", "PEXELS_API_KEY",
        "FERMENTE_PIXABAY_API_KEY", "PIXABAY_API_KEY",
        "FERMENTE_ENGINE_API_KEY", "MPT_API_KEY",
        "FERMENTE_FISH_API_KEY", "FISH_API_KEY",
    ):
